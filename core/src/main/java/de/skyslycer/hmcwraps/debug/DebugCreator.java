...
public class DebugCreator {
    ...
    private static Wrap.WrapValues fillWrapValues(ItemStack item, HMCWraps plugin) {
        ...
        return new Wrap.WrapValues(
                ...
                modifiers.itemsAdder().getOriginalId(item),
                modifiers.oraxen().getOriginalId(item),
                modifiers.mythic().getOriginalId(item),
                modifiers.nexo().getOriginalId(item),
                modifiers.craftEngine().getOriginalId(item),
